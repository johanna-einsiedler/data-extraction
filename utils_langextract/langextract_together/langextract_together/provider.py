...
from langextract_together import schema as custom_schema
...
class TogetherProvider(lx.core.base_model.BaseLanguageModel):
    ...
    def __init__(
        self,
        model_id: str = "deepseek-ai/DeepSeek-R1-Distill-Llama-70B-free",
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
            ...
            raise lx.exceptions.InferenceConfigError(
                "This example requires together package. "
                "Install with: pip install together"
            ) from e

        self.model_id = model_id
        self.api_key = "tgp_v1_85417RzBp36yRbcchAuew8-ChjtpqF4yJD3pJe7aF9A"
        self.temperature = 0
    ...
    def infer(
        ...
        """Required by the abstract base: yield a list of ScoredOutput per prompt."""
        ...
        for prompt in batch_prompts:
            ...
            try:
                ...
                yield [lx.inference.ScoredOutput(score=1.0, output=text.strip())]
            except Exception as e:
                raise lx.exceptions.InferenceRuntimeError(
                    f"Together API error: {e}", original=e
                ) from e
